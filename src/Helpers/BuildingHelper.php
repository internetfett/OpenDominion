...
//                break;
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'smithy' => 'Reduces specialist and elite military unit training costs.<br><br>Training cost reduced by 2% per 1% owned, up to a maximum of 36% at 18% owned. Does not affect Gnome ore costs or any Void unit costs.',
            ...
            'shrine' => 'Reduces offensive casualties.<br><br>Casualties reduced by 5.5% per 1% owned, up to a maximum of 80% at 20% owned.', // todo: hero level gain and hero bonuses
