...
//                break;
    ...
    public function getBuildingHelpString(string $buildingType): ?string
    {
        $helpStrings = [
            ...
            'smithy' => 'Reduces specialist and elite military unit training costs.<br><br>Training cost reduced by 2% per 1% owned, up to a maximum of 40% at 20% owned. Does not affect Gnome ore costs or any Void unit costs.',
