    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            @if (isset($selectedDominion))
                ...
                <li class="{{ Route::is('dominion.techs') ? 'active' : null }}"><a href="{{ route('dominion.techs') }}"><i class="fa fa-flask fa-fw"></i> <span>Advancements</span> {!! $techLevelAffordable > 0 ? ('<span class="pull-right-container"><small class="label pull-right bg-green">' . $techLevelAffordable . '</small></span>') : null !!}</a></li>
                @endif
