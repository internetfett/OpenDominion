                            ...
                            <div class="col-xs-12">
                              <div class="row">
                                  ...
                                  <div class="col-xs-11">
                                    ...
                                    <p>Currently {{ number_format($commonwealth) }} dominions have joined the Commonwealth this round.</p>
                                  </div>
                              <!-- Random Commonwealth -->
                              </div>
                                <div class="row">
                                ...
                                <div class="col-xs-12">
                                  <div class="row">
                                      ...
                                      <div class="col-xs-11">
                                        ...
                                        <p>Currently number_format($evil) dominions have joined the Empire this round.</p>
                                      </div>
                                  </div>
