            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    @if (1-$constructionCalculator->getCostMultiplier($selectedDominion) !== 0)
                      @if (1-$constructionCalculator->getCostMultiplier($selectedDominion) > 0)
                        <p>Bonuses are <em>decreasing your construction costs</em> by <strong>{{ number_format((abs(1-$constructionCalculator->getCostMultiplier($selectedDominion)))*100, 2) }}%</strong>.</p>
                      @else
                        <p>Bonuses are <em>increasing your construction costs</em> by <strong>{{ number_format((abs(1-$constructionCalculator->getCostMultiplier($selectedDominion)))*100, 2) }}%</strong>.</p>
                      @endif
                    @endif
