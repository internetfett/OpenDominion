    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-3">
            <div class="box">
                ...
                <div class="box-body">
                    <p>Exploration will net you additional acres of barren land to construct buildings upon and will take <b>12 ticks</b> to process.</p>
                    ...
                    <p>You have {{ number_format($selectedDominion->resource_platinum) }} platinum, {{ number_format($selectedDominion->military_draftees) }} {{ str_plural('draftee', $selectedDominion->military_draftees) }}, and {{ $selectedDominion->morale/100 }}% morale.</p>
