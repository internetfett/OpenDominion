...
<div class="box box-primary">
    ...
    <div class="box-body">
      ...
      At {{ $website_name }}, accessible from {{ $website_url }}, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by {{ $website_name }} and how we use it.
      ...
      You may consult this list to find the Privacy Policy for each of the advertising partners of {{ $website_name }}.
      ...
      {{ $website_name }}'s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. You may find a complete list of these Privacy Policies and their links here: Privacy Policy Links.
